module.exports = function () {
    ...
    function Tomahawk(config) {
        ...
        if ($this.config.store && $this.config.store.enabled && $this.config.store.implementation) {
            var storeImpl = require(
                                $this.config.store.implementation.charAt(0) === '/' ? $this.config.store.implementation : 
                                path.join($this.config.rootPath, "lib", $this.config.store.implementation)
                            );
